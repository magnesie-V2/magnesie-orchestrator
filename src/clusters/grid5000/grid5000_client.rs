...
impl Grid5000Client {
    ...
    */
    pub fn new(username: String, password: String, site: String, walltime: String, ssh_key_path: String) -> Grid5000Client {
        Grid5000Client {
...
fn launch_grid5000_client() {
    ...
    let cluster = Grid5000Client::new(String::from(username),
